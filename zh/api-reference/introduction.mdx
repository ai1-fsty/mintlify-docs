---
title: "介绍"
description: "Cube AI API 的 Base URL、认证方式、请求格式及错误处理。"
---
...
Cube AI 使用 Bearer Token 认证。在每个请求的 `Authorization` 头中包含你的 API Key：

```
Authorization: Bearer YOUR_API_KEY
```

你可以在 [控制台](https://ai.cubeuaeai.com/console/token) 中生成和管理 API Key。
...
Cube AI 兼容 OpenAI SDK，只需更改 `base_url` 即可使用：
