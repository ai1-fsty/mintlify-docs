---
title: "在 DB-GPT 中使用"
description: "将 Cube AI 模型与 DB-GPT 集成——开源 AI 原生数据应用开发框架。"
---
...
打开 [Cube AI 控制台](https://ai.cubeuaeai.com/) 并注册账号（如果注册过，直接登录即可）。完成注册后，前往 **API 密钥**，创建新的 API Key 并复制。
...
## 4. 通过 DB-GPT Python SDK 使用 Cube AI 模型
...
3. **开始数据对话** — 选择 Cube AI 模型和对应的数据库，开始数据对话。
