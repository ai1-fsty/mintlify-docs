...
打开 [Starrise AI 控制台](https://ai.starrise.tech/) 并注册账号（如果注册过，直接登录即可）。完成注册后，前往 **API 密钥**，创建新的 API Key 并复制。
...
PROXY_OPENAI_API_BASE=https://ai.starrise.tech/v1
PROXY_OPENAI_API_KEY={your-starrise-api-key}
PROXY_OPENAI_BACKEND=gpt-4o

# Embedding 模型配置
EMBEDDING_MODEL=proxy_http_openapi
PROXY_HTTP_OPENAPI_PROXY_SERVER_URL=https://ai.starrise.tech/v1/embeddings
