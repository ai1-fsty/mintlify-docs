...
description: "将 Cube AI 模型与 Deep Research Web UI 集成——AI 驱动的研究助手。"
---
...
### 2.1 配置 Cube AI 大模型服务

* 在 [Cube AI 控制台](https://ai.cubeuaeai.com/) 注册或者登录一个账号。
* 前往 **API 密钥**，生成一个新的 API Key，复制一下。
* 回到 Deep Research 网页，在设置的 **AI 服务** 部分，选择 **OpenAI Compatible**。
* 设置 **Base URL** 为 `https://ai.cubeuaeai.com/v1`。
