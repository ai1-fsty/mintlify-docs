...
description: "通过 OpenAI 兼容接口调用 Anthropic 的 Claude Sonnet 4，智能与速度的最佳平衡，适用于日常编程和复杂任务。"
---

Claude Sonnet 4 是 Anthropic 最佳的编程模型，通过 Starrise AI 以 OpenAI 兼容接口提供服务。在智能、速度和成本之间实现理想平衡，擅长软件工程、复杂推理和日常开发任务。

## 核心能力

* **OpenAI 兼容** — 可直接替换 OpenAI SDK，无需修改其他代码
* **最佳编程模型** — 代码生成、调试和重构表现顶尖
* **快速高效** — 相比 Opus 模型延迟更低、成本更优
* **强大推理** — 擅长多步骤问题求解和分析
* **长上下文** — 支持大文档处理和多轮对话
...
| 参数            | 类型             | 必填 | 说明                             |
| ------------- | -------------- | -- | ------------------------------ |
| `model`       | string         | 是  | 固定为 `claude-sonnet-4-20250514` |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/introduction">
  查看 Claude Sonnet 4 的交互式 API Playground。
</Card>
