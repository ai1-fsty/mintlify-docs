...
description: "通过 OpenAI 兼容接口调用 Anthropic 的 Claude 3.5 Sonnet，快速、强大且易于集成。"
---

Claude 3.5 Sonnet 是 Anthropic 的高性能对话模型，通过 Starrise AI 以 OpenAI 兼容接口提供服务。擅长推理、编程、写作和分析任务。
...
| 参数            | 类型             | 必填 | 说明                       |
| ------------- | -------------- | -- | ------------------------ |
| `model`       | string         | 是  | 固定为 `claude-3-5-sonnet`  |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/introduction">
  查看 Claude 3.5 Sonnet 的交互式 API Playground。
</Card>
