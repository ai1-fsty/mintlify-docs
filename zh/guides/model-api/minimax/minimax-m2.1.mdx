---
title: "MiniMax M2.1"
description: "通过 Starrise AI OpenAI 兼容接口调用 MiniMax M2.1 对话模型，快速、强大且易于集成。"
---

MiniMax M2.1 是通过 Starrise AI 以 OpenAI 兼容接口提供的对话模型。
...
| 参数            | 类型             | 必填 | 说明                       |
| ------------- | -------------- | -- | ------------------------ |
| `model`       | string         | 是  | 固定为 `minimax-m2.1`       |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/minimax/minimax-m2.1">
  查看 MiniMax M2.1 的交互式 API Playground。
</Card>
