---
title: "Qwen3-32B"
description: "通过 Starrise AI OpenAI 兼容接口调用Qwen3-32B 对话模型（阿里巴巴渠道），快速、强大且易于集成。"
---

Qwen3-32B 是通过 Starrise AI 以 OpenAI 兼容接口提供的对话模型。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/alibaba/qwen3-32b">
  查看 Qwen3-32B 的交互式 API Playground。
</Card>
