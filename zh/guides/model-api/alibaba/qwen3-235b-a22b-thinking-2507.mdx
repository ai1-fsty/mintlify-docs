...
description: "通过 Cube AI OpenAI 兼容接口调用Qwen3-235B-A22B-Thinking-2507 思考模型（阿里巴巴渠道），快速、强大且易于集成。"
---

Qwen3-235B-A22B-Thinking-2507 是通过 Cube AI 以 OpenAI 兼容接口提供的对话模型。
