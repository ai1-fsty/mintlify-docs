---
title: "Qwen3.6-Flash"
description: "通过 Cube AI OpenAI 兼容接口调用阿里巴巴 Qwen3.6-Flash 视觉语言模型。快速、智能体友好的多模态模型。"
---

Qwen3.6-Flash 是阿里巴巴的原生视觉语言 Flash 模型，通过 Cube AI 以 OpenAI 兼容接口提供。相比 Qwen3.5-Flash，在智能体编码、数学/代码推理和空间智能方面有显著提升。
