---
title: "GPT-5.2"
description: "OpenAI GPT-5.2 — 最新多模态模型，能力进一步增强。"
---

GPT-5.2 通过 Starrise AI 以 OpenAI Responses API (`/v1/responses`) 提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-2">
  查看 GPT-5.2 的交互式 API Playground。
</Card>
