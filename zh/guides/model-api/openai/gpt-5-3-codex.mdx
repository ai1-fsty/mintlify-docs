---
title: "GPT-5.3 Codex"
description: "OpenAI GPT-5.3 Codex — 最新代码优化模型。"
---

GPT-5.3 Codex 通过 Starrise AI 以 OpenAI Responses API (`/v1/responses`) 提供服务。
...
| 参数                  | 类型             | 必填 | 说明                                   |
| ------------------- | -------------- | -- | ------------------------------------ |
| `model`             | string         | 是  | 固定为 `gpt-5.3-codex`                  |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-3-codex">
  查看 GPT-5.3 Codex 的交互式 API Playground。
</Card>
