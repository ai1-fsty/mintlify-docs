---
title: "GPT-4.1"
description: "OpenAI GPT-4.1 — 快速、强大的多模态模型，指令遵循能力更强。"
---

GPT-4.1 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-4-1">
  查看 GPT-4.1 的交互式 API Playground。
</Card>
