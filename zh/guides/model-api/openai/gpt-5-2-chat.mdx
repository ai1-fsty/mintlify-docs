---
title: "GPT-5.2 Chat"
description: "OpenAI GPT-5.2 Chat — GPT-5.2 对话优化版本。"
---

GPT-5.2 Chat 通过 Starrise AI 以 OpenAI Responses API (`/v1/responses`) 提供服务。
...
| 参数                  | 类型             | 必填 | 说明                                   |
| ------------------- | -------------- | -- | ------------------------------------ |
| `model`             | string         | 是  | 固定为 `gpt-5.2-chat`                   |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-2-chat">
  查看 GPT-5.2 Chat 的交互式 API Playground。
</Card>
