---
title: "GPT-5 Nano"
description: "OpenAI GPT-5 Nano — GPT-5 超轻量低成本版本。"
---

GPT-5 Nano 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-nano">
  查看 GPT-5 Nano 的交互式 API Playground。
</Card>
