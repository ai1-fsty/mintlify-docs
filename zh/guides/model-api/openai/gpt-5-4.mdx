---
title: "GPT-5.4"
description: "OpenAI GPT-5.4 — 最新一代多模态模型。"
---

GPT-5.4 通过 Starrise AI 以 OpenAI Responses API (`/v1/responses`) 提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-4">
  查看 GPT-5.4 的交互式 API Playground。
</Card>
