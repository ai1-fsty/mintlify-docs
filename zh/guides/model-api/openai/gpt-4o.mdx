---
title: "GPT-4o"
description: "OpenAI GPT-4o — 快速多模态旗舰模型，支持文本、视觉和音频。"
---

GPT-4o 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-4o">
  查看 GPT-4o 的交互式 API Playground。
</Card>
