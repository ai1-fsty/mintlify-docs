---
title: "GPT-4o Mini"
description: "OpenAI GPT-4o Mini — 小巧、经济、强大的多模态模型。"
---

GPT-4o Mini 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
| 参数                | 类型             | 必填 | 说明                       |
| ----------------- | -------------- | -- | ------------------------ |
| `model`           | string         | 是  | 固定为 `gpt-4o-mini`        |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-4o-mini">
  查看 GPT-4o Mini 的交互式 API Playground。
</Card>
