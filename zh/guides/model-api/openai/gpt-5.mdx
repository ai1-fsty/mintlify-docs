---
title: "GPT-5"
description: "OpenAI GPT-5 — 新一代多模态模型，具备高级推理能力。"
---

GPT-5 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5">
  查看 GPT-5 的交互式 API Playground。
</Card>
