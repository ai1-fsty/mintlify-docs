---
title: "GPT-5.1"
description: "OpenAI GPT-5.1 — 基于 GPT-5 改进的多模态模型。"
---

GPT-5.1 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-1">
  查看 GPT-5.1 的交互式 API Playground。
</Card>
