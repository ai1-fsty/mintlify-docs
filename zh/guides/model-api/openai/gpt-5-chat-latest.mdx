...
description: "OpenAI GPT-5 Chat Latest — GPT-5 最新对话优化版本。"
---

GPT-5 Chat Latest 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
| 参数                | 类型             | 必填 | 说明                       |
| ----------------- | -------------- | -- | ------------------------ |
| `model`           | string         | 是  | 固定为 `gpt-5-chat-latest`  |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-chat-latest">
  查看 GPT-5 Chat Latest 的交互式 API Playground。
</Card>
