---
title: "GPT-5 Pro"
description: "OpenAI GPT-5 Pro — GPT-5 最强多模态版本。"
---

GPT-5 Pro 通过 Starrise AI 以 OpenAI 兼容接口提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-5-pro">
  查看 GPT-5 Pro 的交互式 API Playground。
</Card>
