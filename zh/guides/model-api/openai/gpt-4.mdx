---
title: "GPT-4"
description: "通过 OpenAI 兼容接口调用 OpenAI GPT-4，强大、可靠，适合复杂任务。"
---

GPT-4 是 OpenAI 的大型多模态模型，通过 Starrise AI 以 OpenAI 兼容接口提供服务。擅长复杂推理、编程、写作和分析任务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/openai/gpt-4">
  查看 GPT-4 的交互式 API Playground。
</Card>
