...
description: "通过 OpenAI 兼容接口调用字节跳动视觉理解对话模型，快速、强大且易于集成。"
---

Doubao Seed 1.6 Vision 是通过 Starrise AI 以 OpenAI 兼容接口提供的对话模型。字节跳动视觉理解对话模型。
...
| 参数            | 类型             | 必填 | 说明                                  |
| ------------- | -------------- | -- | ----------------------------------- |
| `model`       | string         | 是  | 固定为 `doubao-seed-1-6-vision-250815` |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/bytedance/doubao-seed-1-6-vision-250815">
  查看 Doubao Seed 1.6 Vision 的交互式 API Playground。
</Card>
