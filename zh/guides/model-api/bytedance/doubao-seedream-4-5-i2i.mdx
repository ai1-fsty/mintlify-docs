...
description: "字节跳动 Seedream 4.5 图生图模型，使用参考图片和文本提示词生成图片。"
---

Seedream 4.5 图生图是字节跳动 Seedream 系列的图生图模型，通过 Starrise AI API 提供服务。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/bytedance/doubao-seedream-4-5-251128-i2i">
  查看 Seedream 4.5 图生图的交互式 API Playground。
</Card>
