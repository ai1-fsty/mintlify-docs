...
description: "通过 Starrise AI OpenAI 兼容接口调用 DeepSeek V4 Flash，快速、强大且易于集成。"
---

DeepSeek V4 Flash 通过 Starrise AI 以 OpenAI 兼容接口提供服务。支持思考模式、函数调用和 JSON 模式。
...
| 参数                | 类型              | 必填 | 说明                                                                                                       |
| ----------------- | --------------- | -- | -------------------------------------------------------------------------------------------------------- |
| `model`           | string          | 是  | 固定为 `deepseek-v4-flash`                                                                                  |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/deepseek/deepseek-v4-flash">
