---
title: "DeepSeek V3.1"
description: "通过 Starrise AI OpenAI 兼容接口调用 DeepSeek V3.1，快速、强大且易于集成。"
---

DeepSeek V3.1 通过 Starrise AI 以 OpenAI 兼容接口提供服务，擅长复杂推理、编程和多轮对话。
...
| 参数            | 类型             | 必填 | 说明                       |
| ------------- | -------------- | -- | ------------------------ |
| `model`       | string         | 是  | 固定为 `deepseek-v3-1`      |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/deepseek/deepseek-v3-1">
  查看 DeepSeek V3.1 的交互式 API Playground。
</Card>
