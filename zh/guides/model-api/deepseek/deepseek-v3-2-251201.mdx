---
title: "DeepSeek V3.2"
description: "通过 Starrise AI OpenAI 兼容接口调用 DeepSeek V3.2 对话模型，快速、强大且易于集成。"
---

DeepSeek V3.2 是通过 Starrise AI 以 OpenAI 兼容接口提供的强大对话模型，擅长复杂推理、编程和多轮对话。
...
| 参数            | 类型             | 必填 | 说明                         |
| ------------- | -------------- | -- | -------------------------- |
| `model`       | string         | 是  | 固定为 `deepseek-v3-2-251201` |
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/deepseek/deepseek-v3-2-251201">
  查看 DeepSeek V3.2 的交互式 API Playground。
</Card>
