---
title: "GLM-4.5"
description: "通过 OpenAI 兼容接口调用智谱 GLM-4.5 对话模型，快速、强大且易于集成。"
---

GLM-4.5 是智谱 AI 的对话模型，通过 Starrise AI 以 OpenAI 兼容接口提供服务。具备强大的推理和对话能力。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/zhipu/glm-4.5">
  查看 GLM-4.5 的交互式 API Playground。
</Card>
