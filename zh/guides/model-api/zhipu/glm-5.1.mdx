---
title: "GLM-5.1"
description: "通过 OpenAI 兼容接口调用智谱 GLM-5.1 对话模型，最新最强大的 GLM 模型。"
---

GLM-5.1 是智谱 AI 最新的旗舰模型，通过 Starrise AI 以 OpenAI 兼容接口提供服务。在推理、编程和对话任务上达到最先进水平。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/zhipu/glm-5.1">
  查看 GLM-5.1 的交互式 API Playground。
</Card>
