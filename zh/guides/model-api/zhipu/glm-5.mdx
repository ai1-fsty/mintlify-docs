---
title: "GLM-5"
description: "通过 OpenAI 兼容接口调用智谱 GLM-5 对话模型，��大的新一代 GLM 模型。"
---

GLM-5 是智谱 AI 的新一代模型，通过 Starrise AI 以 OpenAI 兼容接口提供服务。在推理、编程和对话任务上表现出色。
...
<Card title="API 参考" icon="code" href="/zh/api-reference/model-api/zhipu/glm-5">
  查看 GLM-5 的交互式 API Playground。
</Card>
