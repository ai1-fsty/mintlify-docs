...
<CodeGroup>
  ```bash cURL
  curl "https://ai.alad.com/v1beta/models/gemini-3.1-flash-image-preview:streamGenerateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.alad.com/v1beta/models/gemini-3.1-flash-image-preview:streamGenerateContent"
