...
description: "通过 Gemini API 调用 Google Gemini 3 Pro Preview。支持思考模式的先进推理能力。"
---

Gemini 3 Pro Preview 是 Google 的先进语言模型，通过 Starrise AI 以原生 Gemini API 提供服务。擅长复杂推理、编程、写作和分析任务，支持思考模式。
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.starrise.tech/v1beta/models/gemini-3-pro-preview:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.starrise.tech/v1beta/models/gemini-3-pro-preview:generateContent"
