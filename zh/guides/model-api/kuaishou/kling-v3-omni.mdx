...
<CodeGroup>
  ```bash cURL — 文生视频
  curl https://ai.starrise.tech/kling/v1/videos/omni-video \
  ...
  response = requests.post(
      "https://ai.starrise.tech/kling/v1/videos/omni-video",
      headers={
...
```bash cURL
curl https://ai.starrise.tech/kling/v1/videos/text2video/{task_id} \
  -H "Authorization: Bearer YOUR_API_KEY"
```
