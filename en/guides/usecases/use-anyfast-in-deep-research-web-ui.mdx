...
description: "Integrate Cube AI models with Deep Research Web UI — an AI-powered research assistant."
---
...
### 2.1 Configure Cube AI LLM Service

* Register or log in at the [Cube AI Console](https://ai.cubeuaeai.com/?lang=en).
...
* Set the **Base URL** to `https://ai.cubeuaeai.com/v1`.
