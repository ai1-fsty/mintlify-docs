...
description: "Integrate Cube AI models with Cline — an AI coding assistant for VS Code."
---
...
* **Base URL**: `https://ai.cubeuaeai.com/v1`
* **API Key**: Enter the API Key obtained from the [Cube AI Console](https://ai.cubeuaeai.com/?lang=en)
* **Model ID**: Enter the model name (e.g. `gpt-4o`, `claude-opus-4-7`)

Once done, you're ready to use Cube AI in Cline.
