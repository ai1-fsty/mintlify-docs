...
description: "Integrate Cube AI models with Janitor AI."
---

## About Janitor AI

Janitor AI is a popular AI tool that supports custom API providers. You can connect it to Cube AI to access a wide range of AI models.
...
## Configure Cube AI in Janitor AI
