...
Open the [Starrise AI Console](https://ai.alad.com/?lang=en) and register an account (or log in if you already have one). After registering, go to **API Keys**, create a new API key, click to copy it, and save it for later use.
