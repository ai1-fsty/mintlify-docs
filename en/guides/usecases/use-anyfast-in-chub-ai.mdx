...
description: "Integrate Cube AI models with Chub AI."
---

## About Chub AI

Chub AI is a popular AI tool that supports custom API providers. You can connect it to Cube AI to access a wide range of AI models.
