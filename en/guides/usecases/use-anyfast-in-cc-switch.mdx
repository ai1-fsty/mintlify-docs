...
description: "Integrate Cube AI models with CC Switch."
---

## About CC Switch

CC Switch is a popular AI tool that supports custom API providers. You can connect it to Cube AI to access a wide range of AI models.
...
## Configure Cube AI in CC Switch
