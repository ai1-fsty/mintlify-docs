...
<AccordionGroup>
  ...
  <Accordion title="How do I get an API key?">
    Register at [ai.alad.com](https://ai.alad.com?lang=en), then go to the [Console](https://ai.alad.com/console/token?lang=en) to create your API key.
  </Accordion>
  ...
  <Accordion title="How does billing work?">
    Starrise AI uses a prepaid credit system. Credits are deducted in real time when API calls are made. Chat models are billed per token; image and video generation models are billed per generation. Go to the [Top Up page](https://ai.alad.com/console/topup?lang=en) to add credits.
  </Accordion>

  <Accordion title="What happens when I run out of credits?">
    API calls will return a `402 Payment Required` error. Top up at the [Console](https://ai.alad.com/console/topup?lang=en) to resume usage.
  </Accordion>
