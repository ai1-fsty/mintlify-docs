---
title: "Kimi-K2.5"
description: "Call the Moonshot Kimi-K2.5 chat model via the Cube AI OpenAI-compatible API — fast, powerful, and easy to integrate."
---

Kimi-K2.5 is a chat model from Moonshot AI, available through Cube AI via an OpenAI-compatible interface.
