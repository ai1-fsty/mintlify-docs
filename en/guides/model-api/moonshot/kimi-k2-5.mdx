---
title: "Kimi-K2.5"
description: "Call the Moonshot Kimi-K2.5 chat model via the Starrise AI OpenAI-compatible API — fast, powerful, and easy to integrate."
---

Kimi-K2.5 is a chat model from Moonshot AI, available through Starrise AI via an OpenAI-compatible interface.
...
| ------------- | -------------- | -------- | ------------------------------------------------ |
| `model`       | string         | Yes      | Fixed value: `kimi-k2.5`                         |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/moonshot/kimi-k2-5">
