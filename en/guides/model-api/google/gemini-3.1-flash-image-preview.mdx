...
description: "Call Google Gemini 3.1 Flash Image Preview via Gemini API for AI image generation and editing."
---

Gemini 3.1 Flash Image Preview is Google's image generation model, available through Cube AI via the native Gemini API. It supports text-to-image generation and image editing with reference images.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent"
