...
Gemini 2.5 Pro is Google's advanced language model, available through Cube AI via the native Gemini API. Excels at complex reasoning, coding, writing, and analytical tasks, with thinking mode support.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-pro:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-pro:generateContent"
