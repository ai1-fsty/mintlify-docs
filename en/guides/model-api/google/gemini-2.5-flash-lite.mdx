...
Gemini 2.5 Flash Lite is the lightest and most efficient language model in Google's 2.5 series, available through Cube AI via the native Gemini API. Ideal for large-scale scenarios that are sensitive to response speed and cost.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-flash-lite:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-flash-lite:generateContent"
