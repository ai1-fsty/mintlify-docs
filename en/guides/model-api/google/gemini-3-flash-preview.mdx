...
Gemini 3 Flash Preview is Google's fast language model, available through Cube AI via the native Gemini API. Designed for applications requiring quick responses and high throughput, with strong language understanding capabilities.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-3-flash-preview:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-3-flash-preview:generateContent"
