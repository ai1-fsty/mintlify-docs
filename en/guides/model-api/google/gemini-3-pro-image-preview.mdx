...
Gemini 3 Pro Image Preview is Google's image generation model, available through Starrise AI via the native Gemini API. It supports text-to-image generation and image editing with reference images.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.alad.com/v1beta/models/gemini-3-pro-image-preview:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.alad.com/v1beta/models/gemini-3-pro-image-preview:generateContent"
