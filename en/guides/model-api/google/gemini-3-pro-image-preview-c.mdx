...
description: "Call gemini-3-pro-image-preview-c via Gemini API for AI image generation and editing."
---

gemini-3-pro-image-preview-c is Google's image generation model, available through Cube AI via the native Gemini API. It supports text-to-image generation and image editing with reference images.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-3-pro-image-preview-c:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-3-pro-image-preview-c:generateContent"
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/google/gemini-3-pro-image-preview-c">
