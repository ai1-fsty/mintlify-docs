...
Gemini 2.5 Flash is Google's fast, efficient model with integrated Google Search functionality, available through Cube AI via the native Gemini API. Responses can be enhanced with real-time search results.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-flash:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-flash:generateContent"
