...
Gemini 2.5 Flash Image is Google's image generation model, available through Cube AI via the native Gemini API. It supports text-to-image generation and image editing with reference images.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-flash-image:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-2.5-flash-image:generateContent"
