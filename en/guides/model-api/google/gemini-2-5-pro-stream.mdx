...
Gemini 2.5 Pro (Stream) provides streaming text generation based on the Google Gemini 2.5 Pro model, accessible through Cube AI. Responses are delivered in real time via Server-Sent Events (SSE).
