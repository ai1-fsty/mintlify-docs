...
Gemini 2.0 Flash is Google's multimodal model with image editing capabilities, available through Cube AI via the native Gemini API. It can edit existing images based on text instructions.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-2.0-flash:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-2.0-flash:generateContent"
