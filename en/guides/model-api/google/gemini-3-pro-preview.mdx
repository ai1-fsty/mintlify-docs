...
description: "Call Google Gemini 3 Pro Preview via Gemini API. Advanced reasoning with thinking mode support."
---

Gemini 3 Pro Preview is Google's advanced language model, available through Cube AI via the native Gemini API. Excels at complex reasoning, coding, writing, and analytical tasks, with thinking mode support.
...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/v1beta/models/gemini-3-pro-preview:generateContent?key=YOUR_API_KEY" \
  ...
  url = "https://ai.cubeuaeai.com/v1beta/models/gemini-3-pro-preview:generateContent"
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/google/gemini-3-pro-preview">
