...
Claude 3.5 Sonnet is Anthropic's high-performance conversational model, available through Cube AI via OpenAI-compatible interface. It excels at reasoning, coding, writing, and analysis tasks.
