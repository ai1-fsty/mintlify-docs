...
Claude Sonnet 4 Thinking is the Extended Thinking version of Claude Sonnet 4, available through Cube AI via OpenAI-compatible interface. Combining Sonnet's excellent balance of speed and capability with step-by-step internal reasoning enabled by default, it significantly improves accuracy on complex tasks while maintaining fast response times.
