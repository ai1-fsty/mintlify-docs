---
title: "Claude Sonnet 4.5 Thinking"
description: "Anthropic's Claude Sonnet 4.5 with Extended Thinking — enhanced reasoning at the speed and capability of the best coding model."
---

Claude Sonnet 4.5 Thinking is the Extended Thinking version of Claude Sonnet 4.5, available through Cube AI via OpenAI-compatible interface. Combining Sonnet 4.5's excellent balance of speed and capability with step-by-step internal reasoning enabled by default, it significantly improves accuracy on complex tasks while maintaining fast response times.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/anthropic/claude-sonnet-4-5-20250929-thinking">
