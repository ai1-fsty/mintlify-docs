...
description: "Call Anthropic's Claude Opus 4.5 via OpenAI-compatible interface — the most intelligent Claude model, with top-tier reasoning and creativity."
---

Claude Opus 4.5 is Anthropic's most intelligent and capable model, available through Cube AI via OpenAI-compatible interface. It leads all benchmarks with the deepest reasoning, strongest coding abilities, and most nuanced creative writing.
...
| ------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `claude-opus-4-5` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/anthropic/claude-opus-4-5-20251101">
