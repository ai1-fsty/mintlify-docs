...
Claude Opus 4.8 is Anthropic's most capable general-purpose model, available through Cube AI via OpenAI-compatible interface. Built on Claude Opus 4.7, it features improvements in long-horizon agentic coding, tool-trigger reliability, and compression handling.
