...
description: "ByteDance Seedance 1.5 Pro image-to-video model — uses a reference image as the first frame (and optionally the last frame) to generate video."
---

Seedance 1.5 Pro Image-to-Video is an image-to-video model from ByteDance's Seedance series, available through the Starrise AI API. It uses a reference image as the first frame (and optionally the last frame) to generate video.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/bytedance/doubao-seedance-1-5-pro-251215-i2v">
  View the interactive API Playground for Seedance 1.5 Pro Image-to-Video.
</Card>
