...
description: "Manage images, videos, and audio assets for Seedance 2.0 video generation via the Cube AI API."
---
...
<CodeGroup>
  ...
  response = requests.post(
      "https://ai.cubeuaeai.com/volc/asset/CreateAssetGroup",
...
<CodeGroup>
  ...
  ```python Python
  response = requests.post(
      "https://ai.cubeuaeai.com/volc/asset/CreateAsset",
      headers={"Authorization": "Bearer YOUR_API_KEY"},
      json={
          "model": "volc-asset",
          "GroupId": "group-20260427160000-xxxxx",
...
```bash cURL
curl https://ai.cubeuaeai.com/volc/asset/ListAssetGroups \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "volc-asset",
...
```bash cURL
curl https://ai.cubeuaeai.com/volc/asset/ListAssets \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "model": "volc-asset",
