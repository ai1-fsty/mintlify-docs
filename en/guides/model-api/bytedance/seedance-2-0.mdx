---
title: "Seedance 2.0"
description: "Call ByteDance's Seedance video generation model via Cube AI API — supports multimodal references, video editing, extension, audio generation, and web search enhancement."
---

Seedance 2.0 is ByteDance's latest video generation model, available through the Cube AI API. It supports text-to-video, image-to-video, multimodal reference input, video editing, video extension, and synchronized audio generation.
...
```bash
curl https://ai.cubeuaeai.com/volc/asset/CreateAssetGroup \
...
```bash
curl https://ai.cubeuaeai.com/v1/video/generations/asynxxxx \
  -H "Authorization: Bearer YOUR_API_KEY"
```
