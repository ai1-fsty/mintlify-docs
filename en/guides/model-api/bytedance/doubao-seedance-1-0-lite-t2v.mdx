...
Seedance 1.0 Lite Text-to-Video is a video generation model from ByteDance's Seedance series, available through the Cube AI API. It uses a multimodal content format to create videos from text prompts and reference images.
