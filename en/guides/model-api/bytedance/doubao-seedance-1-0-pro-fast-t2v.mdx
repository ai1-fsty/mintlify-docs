...
description: "ByteDance Seedance 1.0 Pro Fast text-to-video model — generates video from text prompts."
---

Seedance 1.0 Pro Fast Text-to-Video is a text-to-video model from ByteDance's Seedance series, available through the Starrise AI API.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/bytedance/doubao-seedance-1-0-pro-fast-251015-t2v">
  View the interactive API Playground for Seedance 1.0 Pro Fast Text-to-Video.
</Card>
