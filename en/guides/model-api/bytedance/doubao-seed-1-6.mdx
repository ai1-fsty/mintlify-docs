...
description: "Call ByteDance's balanced-performance chat model via an OpenAI-compatible API — fast, powerful, and easy to integrate."
---

Doubao Seed 1.6 is a chat model available through Starrise AI via an OpenAI-compatible API. ByteDance's balanced-performance chat model.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/bytedance/doubao-seed-1-6-251015">
