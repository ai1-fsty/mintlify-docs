...
Seedance 1.0 Pro Image-to-Video is an image-to-video model from ByteDance's Seedance series, available through the Cube AI API. It uses a reference image as the first frame (and optionally the last frame) to generate video.
