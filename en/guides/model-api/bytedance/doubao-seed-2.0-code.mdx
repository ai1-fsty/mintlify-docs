...
description: "ByteDance's Seed 2.0 Code programming model — optimized for code generation and understanding."
---

Doubao Seed 2.0 Code is a chat model available through Starrise AI via an OpenAI-compatible API. ByteDance's Seed 2.0 Code programming model — optimized for code generation and understanding.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/bytedance/doubao-seed-2.0-code">
