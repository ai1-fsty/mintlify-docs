...
description: "ByteDance Seedream 5.0 image-to-image model — generate images using reference images and text prompts."
---

Seedream 5.0 Image-to-Image is an image-to-image model from ByteDance's Seedream series, available through the Cube AI API.
