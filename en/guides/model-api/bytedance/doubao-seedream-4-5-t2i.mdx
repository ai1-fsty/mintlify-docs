...
description: "ByteDance Seedream 4.5 text-to-image model — generate images from text prompts."
---

Seedream 4.5 Text-to-Image is a text-to-image model from ByteDance's Seedream series, available through the Cube AI API.
