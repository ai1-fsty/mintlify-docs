...
description: "Call ByteDance's Seedance Ultra video generation model via Cube AI API — supports multimodal references, video editing, extension, audio generation, and web search enhancement."
---

Seedance 2.0 Ultra is ByteDance's latest video generation model, available through the Cube AI API. It supports text-to-video, image-to-video, multimodal reference input, video editing, video extension, and synchronized audio generation.
