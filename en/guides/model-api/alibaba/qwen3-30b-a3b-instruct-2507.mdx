...
description: "Call Qwen3-30B-A3B-Instruct-2507 chat model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-30B-A3B-Instruct-2507 is a chat model available through Cube AI via an OpenAI-compatible API.
