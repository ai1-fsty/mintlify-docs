...
description: "Call Qwen3-VL-235B-A22B-Instruct vision model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-VL-235B-A22B-Instruct is a vision model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen3-vl-235b-a22b-instruct`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3-vl-235b-a22b-instruct">
  View the interactive API Playground for Qwen3-VL-235B-A22B-Instruct.
</Card>
