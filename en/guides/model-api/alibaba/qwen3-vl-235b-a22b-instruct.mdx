...
description: "Call Qwen3-VL-235B-A22B-Instruct vision model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-VL-235B-A22B-Instruct is a vision model available through Cube AI via an OpenAI-compatible API.
