---
title: "Wan2.7 Image"
description: "Call Alibaba's Wanxiang Image Generation & Editing 2.7 model via the Cube AI API."
---

Wanxiang Image Generation & Editing 2.7 (Wan2.7 Image) is Alibaba's latest multimodal image model, available through Cube AI. Supports text-to-image, image editing, interactive region editing, and multi-image generation with up to 4K output resolution.
