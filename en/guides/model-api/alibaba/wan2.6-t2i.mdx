---
title: "Wan2.6 T2I"
description: "Call Alibaba's Wan2.6 T2I text-to-image model via the Cube AI API."
---

Wan2.6 T2I is a text-to-image model available through Cube AI. The API is **synchronous** — it automatically polls the upstream asynchronous task and directly returns the final image URL.
