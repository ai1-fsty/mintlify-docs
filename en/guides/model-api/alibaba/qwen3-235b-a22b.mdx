...
description: "Call Qwen3-235B-A22B chat model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-235B-A22B is a chat model available through Cube AI via an OpenAI-compatible API.
