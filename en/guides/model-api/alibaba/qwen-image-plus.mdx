...
description: "Call Alibaba's Qwen Image Plus text-to-image model via the Cube AI API."
---

Qwen Image Plus is a text-to-image model available through Cube AI. The API is **synchronous** — it automatically polls the upstream asynchronous task and directly returns the final image URL.
