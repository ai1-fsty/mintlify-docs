...
description: "Call Qwen3-30B-A3B-Thinking-2507 thinking model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-30B-A3B-Thinking-2507 is a thinking model available through Cube AI via an OpenAI-compatible API.
