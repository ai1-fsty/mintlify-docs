...
description: "Call Qwen3-30B-A3B-Thinking-2507 thinking model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-30B-A3B-Thinking-2507 is a thinking model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen3-30b-a3b-thinking-2507`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3-30b-a3b-thinking-2507">
  View the interactive API Playground for Qwen3-30B-A3B-Thinking-2507.
</Card>
