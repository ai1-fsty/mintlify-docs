...
description: "Call Qwen2.5-32B-Instruct chat model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen2.5-32B-Instruct is a chat model available through Starrise AI via an OpenAI-compatible API.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen2.5-32b-instruct">
