...
description: "Call Qwen2.5-VL-32B-Instruct vision model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen2.5-VL-32B-Instruct is a vision model available through Cube AI via an OpenAI-compatible API.
