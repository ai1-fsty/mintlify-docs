...
description: "Call Qwen3-Next-80B-A3B-Instruct chat model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-Next-80B-A3B-Instruct is a chat model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen3-next-80b-a3b-instruct`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3-next-80b-a3b-instruct">
  View the interactive API Playground for Qwen3-Next-80B-A3B-Instruct.
</Card>
