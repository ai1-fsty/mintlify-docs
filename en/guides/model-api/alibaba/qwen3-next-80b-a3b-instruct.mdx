...
description: "Call Qwen3-Next-80B-A3B-Instruct chat model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-Next-80B-A3B-Instruct is a chat model available through Cube AI via an OpenAI-compatible API.
