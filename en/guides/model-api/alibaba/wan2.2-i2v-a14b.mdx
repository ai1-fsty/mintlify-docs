...
description: "Call Alibaba's Wan2.2 I2V A14B image-to-video model via the Cube AI API."
---

Wan2.2 I2V A14B is an image-to-video model available through Cube AI. Video generation is an **asynchronous call** — after submitting a task, poll `GET /v1/video/generations/{task_id}` until `status` is `succeeded`.
