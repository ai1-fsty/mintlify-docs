...
description: "Call Qwen2.5-VL-72B-Instruct vision model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen2.5-VL-72B-Instruct is a vision model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen2.5-vl-72b-instruct`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen2.5-vl-72b-instruct">
  View the interactive API Playground for Qwen2.5-VL-72B-Instruct.
</Card>
