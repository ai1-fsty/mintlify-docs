...
description: "Call Qwen3-Coder-Next code model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-Coder-Next is a code model available through Cube AI via an OpenAI-compatible API.
