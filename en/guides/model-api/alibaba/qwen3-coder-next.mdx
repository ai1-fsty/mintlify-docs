...
description: "Call Qwen3-Coder-Next code model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-Coder-Next is a code model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen3-coder-next`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3-coder-next">
  View the interactive API Playground for Qwen3-Coder-Next.
</Card>
