...
description: "Call Qwen3.5-397B-A17B chat model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3.5-397B-A17B is a chat model available through Starrise AI via an OpenAI-compatible API.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3.5-397b-a17b">
  View the interactive API Playground for Qwen3.5-397B-A17B.
</Card>
