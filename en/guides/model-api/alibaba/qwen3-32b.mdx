---
title: "Qwen3-32B"
description: "Call Qwen3-32B chat model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-32B is a chat model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen3-32b`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3-32b">
  View the interactive API Playground for Qwen3-32B.
</Card>
