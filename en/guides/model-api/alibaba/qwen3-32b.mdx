---
title: "Qwen3-32B"
description: "Call Qwen3-32B chat model via Cube AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-32B is a chat model available through Cube AI via an OpenAI-compatible API.
