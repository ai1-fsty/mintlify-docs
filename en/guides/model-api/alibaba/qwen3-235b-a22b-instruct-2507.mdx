...
description: "Call Qwen3-235B-A22B-Instruct-2507 chat model via Starrise AI OpenAI-compatible API (Alibaba channel) — fast, powerful, and easy to integrate."
---

Qwen3-235B-A22B-Instruct-2507 is a chat model available through Starrise AI via an OpenAI-compatible API.
...
| ------------- | -------------- | -------- | ---------------------------------------- |
| `model`       | string         | Yes      | Must be `qwen3-235b-a22b-instruct-2507`                     |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/alibaba/qwen3-235b-a22b-instruct-2507">
  View the interactive API Playground for Qwen3-235B-A22B-Instruct-2507.
</Card>
