...
description: "Call DeepSeek V3.1 Terminus via Cube AI OpenAI-compatible interface — fast, powerful, and easy to integrate."
---

DeepSeek V3.1 Terminus is available through Cube AI via the OpenAI-compatible interface, excelling at complex reasoning, coding, and multi-turn conversations.
...
| ------------- | -------------- | -- | ---------------------------- |
| `model` | string | Yes | Fixed value: `deepseek-v3-1-terminus` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/deepseek/deepseek-v3-1-terminus">
