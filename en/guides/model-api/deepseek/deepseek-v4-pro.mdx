...
description: "Call DeepSeek V4 Pro via Cube AI OpenAI-compatible interface — fast, powerful, and easy to integrate."
---

DeepSeek V4 Pro is available through Cube AI via the OpenAI-compatible interface. Supports thinking mode, function calling, and JSON mode.
