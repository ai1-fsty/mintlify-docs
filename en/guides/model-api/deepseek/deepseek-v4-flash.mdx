...
description: "Call DeepSeek V4 Flash via Cube AI OpenAI-compatible interface — fast, powerful, and easy to integrate."
---

DeepSeek V4 Flash is available through Cube AI via the OpenAI-compatible interface. Supports thinking mode, function calling, and JSON mode.
