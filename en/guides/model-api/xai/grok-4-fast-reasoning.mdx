...
description: "Call xAI Grok 4 Fast Reasoning via Cube AI API. Grok 4 reasoning variant."
---

Grok 4 Fast Reasoning is xAI's language model, available through Cube AI. Grok 4 reasoning variant.
