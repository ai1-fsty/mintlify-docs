...
description: "Call xAI Grok 4.1 Fast Reasoning via Cube AI API. Grok 4.1 reasoning variant."
---

Grok 4.1 Fast Reasoning is xAI's language model, available through Cube AI. Grok 4.1 reasoning variant.
