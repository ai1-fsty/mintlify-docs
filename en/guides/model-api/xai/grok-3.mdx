---
title: "Grok 3"
description: "Call xAI Grok 3 via Starrise AI API. xAI's most capable model."
---

Grok 3 is xAI's language model, available through Starrise AI. xAI's most capable model.
...
| ------------- | ------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `grok-3` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/xai/grok-3">
