...
description: "Call xAI Grok 4.1 Fast Non-Reasoning via Cube AI API. Grok 4.1 non-reasoning variant."
---

Grok 4.1 Fast Non-Reasoning is xAI's language model, available through Cube AI. Grok 4.1 non-reasoning variant.
