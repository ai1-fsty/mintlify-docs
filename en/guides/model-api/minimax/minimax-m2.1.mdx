---
title: "MiniMax M2.1"
description: "Call the MiniMax M2.1 chat model via the Cube AI OpenAI-compatible API — fast, powerful, and easy to integrate."
---

MiniMax M2.1 is a chat model available through Cube AI via an OpenAI-compatible interface.
