---
title: "MiniMax M2.1"
description: "Call the MiniMax M2.1 chat model via the Starrise AI OpenAI-compatible API — fast, powerful, and easy to integrate."
---

MiniMax M2.1 is a chat model available through Starrise AI via an OpenAI-compatible interface.
...
| ------------- | -------------- | -------- | ------------------------------------------------ |
| `model`       | string         | Yes      | Fixed value: `minimax-m2.1`                      |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/minimax/minimax-m2.1">
  View the interactive API Playground for MiniMax M2.1.
</Card>
