---
title: "MiniMax-M2.7"
description: "Call the MiniMax-M2.7 flagship text model via the Cube AI OpenAI-compatible API. Advanced reasoning with recursive self-improvement."
---

MiniMax-M2.7 is MiniMax's flagship text model, available through Cube AI via an OpenAI-compatible interface. It features a 204K context window with interleaved thinking support, ideal for complex reasoning tasks.
