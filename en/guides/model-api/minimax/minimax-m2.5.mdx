---
title: "MiniMax M2.5"
description: "Call the MiniMax M2.5 chat model via the Cube AI OpenAI-compatible API — fast, powerful, and easy to integrate."
---

MiniMax M2.5 is a chat model available through Cube AI via an OpenAI-compatible interface.
