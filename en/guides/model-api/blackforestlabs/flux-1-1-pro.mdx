---
title: "FLUX.1.1 [pro]"
description: "Call the Black Forest Labs FLUX.1.1 [pro] text-to-image model via the Cube AI API."
---

FLUX.1.1 \[pro] is a high-quality text-to-image model from Black Forest Labs, available through Cube AI. The API uses **synchronous calls** — it directly returns Base64-encoded image data.
