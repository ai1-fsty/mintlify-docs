---
title: "GPT-5.1 Chat"
description: "OpenAI GPT-5.1 Chat — conversation-optimized version of GPT-5.1."
---

GPT-5.1 Chat is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5.1-chat` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-1-chat">
  View the interactive API Playground for GPT-5.1 Chat.
</Card>
