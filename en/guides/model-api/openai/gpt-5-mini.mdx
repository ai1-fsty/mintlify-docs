---
title: "GPT-5 Mini"
description: "OpenAI GPT-5 Mini — compact, cost-effective version of GPT-5."
---

GPT-5 Mini is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5-mini` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-mini">
  View the interactive API Playground for GPT-5 Mini.
</Card>
