...
description: "OpenAI GPT-5 Codex High — high-compute code generation version of GPT-5."
---

GPT-5 Codex High is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5-codex-high` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-codex-high">
  View the interactive API Playground for GPT-5 Codex High.
</Card>
