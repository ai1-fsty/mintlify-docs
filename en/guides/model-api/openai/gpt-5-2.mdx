---
title: "GPT-5.2"
description: "OpenAI GPT-5.2 — latest multimodal model with further enhanced capabilities."
---

GPT-5.2 is available through Cube AI via OpenAI Responses API (`/v1/responses`).
...
| ------------------- | -------------- | -- | ------------------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5.2` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-2">
