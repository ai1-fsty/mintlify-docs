---
title: "GPT-4.1"
description: "OpenAI GPT-4.1 — fast, powerful multimodal model with stronger instruction following."
---

GPT-4.1 is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-4.1` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-4-1">
  View the interactive API Playground for GPT-4.1.
</Card>
