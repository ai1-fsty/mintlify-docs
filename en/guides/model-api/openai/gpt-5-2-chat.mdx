---
title: "GPT-5.2 Chat"
description: "OpenAI GPT-5.2 Chat — conversation-optimized version of GPT-5.2."
---

GPT-5.2 Chat is available through Cube AI via OpenAI Responses API (`/v1/responses`).
...
| ------------------- | -------------- | -- | ------------------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5.2-chat` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-2-chat">
