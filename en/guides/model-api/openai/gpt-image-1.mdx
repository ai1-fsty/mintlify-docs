...
GPT Image 1 is OpenAI's autoregressive image generation model, available through the Cube AI API. It generates high-quality images from text prompts, with precise text rendering and multi-style generation support.
