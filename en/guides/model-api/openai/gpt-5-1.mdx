---
title: "GPT-5.1"
description: "OpenAI GPT-5.1 — improved multimodal model based on GPT-5."
---

GPT-5.1 is available through Starrise AI via OpenAI-compatible interface.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-1">
