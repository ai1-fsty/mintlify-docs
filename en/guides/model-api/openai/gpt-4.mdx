---
title: "GPT-4"
description: "Call OpenAI GPT-4 via OpenAI-compatible interface — powerful, reliable, ideal for complex tasks."
---

GPT-4 is OpenAI's large multimodal model, available through Starrise AI via OpenAI-compatible interface. It excels at complex reasoning, coding, writing, and analysis tasks.
...
| ------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-4` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-4">
