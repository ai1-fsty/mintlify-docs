...
GPT-4 is OpenAI's large multimodal model, available through Cube AI via OpenAI-compatible interface. It excels at complex reasoning, coding, writing, and analysis tasks.
