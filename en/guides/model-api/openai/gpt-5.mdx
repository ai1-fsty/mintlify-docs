---
title: "GPT-5"
description: "OpenAI GPT-5 — next-generation multimodal model with advanced reasoning."
---

GPT-5 is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5">
  View the interactive API Playground for GPT-5.
</Card>
