...
description: "OpenAI GPT-5 Codex Low — efficient code generation version of GPT-5."
---

GPT-5 Codex Low is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5-codex-low` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-codex-low">
