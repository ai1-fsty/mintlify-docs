...
description: "OpenAI GPT-5.1 Codex Mini — compact, code-optimized version of GPT-5.1."
---

GPT-5.1 Codex Mini is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5.1-codex-mini` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-1-codex-mini">
  View the interactive API Playground for GPT-5.1 Codex Mini.
</Card>
