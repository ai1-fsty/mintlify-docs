...
description: "OpenAI GPT-5.2 Chat Latest — the latest conversation-optimized version of GPT-5.2."
---

GPT-5.2 Chat Latest is available through Cube AI via OpenAI Responses API (`/v1/responses`).
...
| ------------------- | -------------- | -- | ------------------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5.2-chat-latest` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-2-chat-latest">
  View the interactive API Playground for GPT-5.2 Chat Latest.
</Card>
