---
title: "GPT-4o"
description: "OpenAI GPT-4o — fast multimodal flagship model with text, vision, and audio support."
---

GPT-4o is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-4o` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-4o">
  View the interactive API Playground for GPT-4o.
</Card>
