---
title: "GPT-5.4"
description: "OpenAI GPT-5.4 — next-generation multimodal model."
---

GPT-5.4 is available through Cube AI via OpenAI Responses API (`/v1/responses`).
...
| ------------------- | -------------- | -- | ------------------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5.4` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-4">
  View the interactive API Playground for GPT-5.4.
</Card>
