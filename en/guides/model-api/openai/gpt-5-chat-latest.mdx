...
description: "OpenAI GPT-5 Chat Latest — the latest conversation-optimized version of GPT-5."
---

GPT-5 Chat Latest is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5-chat-latest` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-chat-latest">
  View the interactive API Playground for GPT-5 Chat Latest.
</Card>
