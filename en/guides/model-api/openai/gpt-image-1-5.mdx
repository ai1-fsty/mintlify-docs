...
GPT Image 1.5 is OpenAI's latest image generation model based on the GPT-5 architecture, available through the Cube AI API. It's 4× faster and 20% cheaper than GPT Image 1, with significantly improved text rendering and editing precision.
