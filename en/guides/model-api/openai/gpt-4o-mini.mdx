---
title: "GPT-4o Mini"
description: "OpenAI GPT-4o Mini — compact, affordable, and capable multimodal model."
---

GPT-4o Mini is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-4o-mini` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-4o-mini">
  View the interactive API Playground for GPT-4o Mini.
</Card>
