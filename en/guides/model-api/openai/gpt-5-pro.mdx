---
title: "GPT-5 Pro"
description: "OpenAI GPT-5 Pro — the most powerful multimodal version of GPT-5."
---

GPT-5 Pro is available through Cube AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5-pro` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-pro">
