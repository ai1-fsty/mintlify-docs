---
title: "GPT-5 Nano"
description: "OpenAI GPT-5 Nano — ultra-lightweight, low-cost version of GPT-5."
---

GPT-5 Nano is available through Starrise AI via OpenAI-compatible interface.
...
| ----------------- | -------------- | -- | ------------------------ |
| `model` | string | Yes | Fixed value: `gpt-5-nano` |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/openai/gpt-5-nano">
  View the interactive API Playground for GPT-5 Nano.
</Card>
