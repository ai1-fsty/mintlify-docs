...
GLM-4-7 is a chat model from Zhipu AI, available through Cube AI via an OpenAI-compatible interface. It features powerful reasoning and conversational capabilities.
