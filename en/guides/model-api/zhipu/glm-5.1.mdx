...
GLM-5.1 is Zhipu AI's latest flagship model, available through Cube AI via an OpenAI-compatible interface. It achieves state-of-the-art performance on reasoning, coding, and conversational tasks.
