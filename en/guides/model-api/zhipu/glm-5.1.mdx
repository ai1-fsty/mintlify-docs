---
title: "GLM-5.1"
description: "Call the Zhipu GLM-5.1 chat model via the OpenAI-compatible API — the latest and most powerful GLM model."
---

GLM-5.1 is Zhipu AI's latest flagship model, available through Starrise AI via an OpenAI-compatible interface. It achieves state-of-the-art performance on reasoning, coding, and conversational tasks.
...
| ------------- | -------------- | -------- | ------------------------------------------------ |
| `model`       | string         | Yes      | Fixed value: `glm-5.1`                           |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/zhipu/glm-5.1">
  View the interactive API Playground for GLM-5.1.
</Card>
