...
Kling 1.6 Multi-Image-to-Video is a multi-image-to-video model in Kuaishou's Kling series, available through the Cube AI API. Upload up to 4 reference images and combine them with a text prompt to generate a coherent video featuring all referenced subjects.
...
<CodeGroup>
  ```bash cURL
  curl https://ai.cubeuaeai.com/kling/v1/videos/multi-image2video \
  ...
  response = requests.post(
      "https://ai.cubeuaeai.com/kling/v1/videos/multi-image2video",
      headers={
