---
title: "Kling 2.1 Master Text-to-Video"
description: "Kuaishou Kling 2.1 Master text-to-video model. Generate videos from text prompts with custom camera control, multi-shot scenes, and sound effects."
---

Kling 2.1 Master Text-to-Video is a text-to-video model in Kuaishou's Kling series, available through the Cube AI API. Create videos from text descriptions with custom camera control, multi-shot scenes, and optional sound effect generation.
...
<CodeGroup>
  ```bash cURL
  curl https://ai.cubeuaeai.com/kling/v1/videos/text2video \
  ...
  response = requests.post(
      "https://ai.cubeuaeai.com/kling/v1/videos/text2video",
      headers={
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/kuaishou/kling-v2-1-master-t2v">
  View the interactive API Playground for Kling 2.1 Master Text-to-Video.
</Card>
