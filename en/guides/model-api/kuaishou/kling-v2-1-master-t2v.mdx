...
Kling 2.1 Master Text-to-Video is a text-to-video model in Kuaishou's Kling series, available through the Starrise AI API. Create videos from text descriptions with custom camera control, multi-shot scenes, and optional sound effect generation.
