...
Kling 2 Master Image-to-Video is an image-to-video model in Kuaishou's Kling series, available through the Starrise AI API. Transform static images into dynamic videos with custom camera control, motion brush, and multi-shot scenes.
