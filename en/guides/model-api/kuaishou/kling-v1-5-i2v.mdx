...
description: "Kuaishou Kling 1.5 image-to-video model. Generate videos from reference images with custom camera control, motion brush, and multi-shot scenes."
---

Kling 1.5 Image-to-Video is an image-to-video model in Kuaishou's Kling series, available through the Cube AI API. Transform static images into dynamic videos with custom camera control, motion brush, and multi-shot scenes.
...
<CodeGroup>
  ```bash cURL
  curl https://ai.cubeuaeai.com/kling/v1/videos/image2video \
  ...
  response = requests.post(
      "https://ai.cubeuaeai.com/kling/v1/videos/image2video",
      headers={
...
| ----------------- | ------ | ----------------- | --------------------------------------------------- |
| `model_name`      | string | No                | Must be `kling-v1-5`                              |
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/kuaishou/kling-v1-5-i2v">
  View the interactive API Playground for Kling 1.5 Image-to-Video.
</Card>
