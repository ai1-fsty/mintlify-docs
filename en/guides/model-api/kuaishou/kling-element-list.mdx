...
<CodeGroup>
  ```bash cURL
  curl "https://ai.cubeuaeai.com/kling/v1/general/advanced-custom-elements?pageNum=1&pageSize=10" \
  ...
  response = requests.get(
      "https://ai.cubeuaeai.com/kling/v1/general/advanced-custom-elements",
