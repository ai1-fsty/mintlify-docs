...
description: "Kuaishou Kling 1.6 text-to-video model. Generate videos from text prompts with custom camera control, multi-shot scenes, and sound effects."
---

Kling 1.6 Text-to-Video is a text-to-video model in Kuaishou's Kling series, available through the Cube AI API. Create videos from text descriptions with custom camera control, multi-shot scenes, and optional sound effect generation.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/kuaishou/kling-v1-6-t2v">
  View the interactive API Playground for Kling 1.6 Text-to-Video.
</Card>
