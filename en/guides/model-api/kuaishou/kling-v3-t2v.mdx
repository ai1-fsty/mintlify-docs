...
description: "Kuaishou Kling 3.0 text-to-video model. Generate videos from text prompts with custom camera control, multi-shot scenes, and sound effects."
---

Kling 3.0 Text-to-Video is a text-to-video model in Kuaishou's Kling series, available through the Cube AI API. Create videos from text descriptions with custom camera control, multi-shot scenes, and optional sound effect generation.
...
<Card title="API Reference" icon="code" href="/en/api-reference/model-api/kuaishou/kling-v3-t2v">
  View the interactive API Playground for Kling 3.0 Text-to-Video.
</Card>
