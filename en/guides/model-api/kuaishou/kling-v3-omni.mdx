...
Kling V3 Omni is Kuaishou's latest video generation model, available through the Cube AI API. The Omni model combines elements, images, videos, and more via prompts for diverse capabilities — supporting text-to-video, image-to-video, video editing, multi-shot scenes, and synchronized sound effect generation.
...
<CodeGroup>
  ...
  curl https://ai.cubeuaeai.com/kling/v1/videos/omni-video \
  ...
  response = requests.post(
      "https://ai.cubeuaeai.com/kling/v1/videos/omni-video",
      headers={
...
```bash cURL
curl https://ai.cubeuaeai.com/kling/v1/videos/text2video/{task_id} \
  -H "Authorization: Bearer YOUR_API_KEY"
```
