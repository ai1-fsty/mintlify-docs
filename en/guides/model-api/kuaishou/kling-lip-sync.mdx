...
<CodeGroup>
  ```bash cURL
  curl https://ai.cubeuaeai.com/kling/v1/videos/advanced-lip-sync \
  ...
  response = requests.post(
      "https://ai.cubeuaeai.com/kling/v1/videos/advanced-lip-sync",
      headers={
...
<CodeGroup>
  ...
  while True:
      result = requests.get(
          f"https://ai.cubeuaeai.com/kling/v1/videos/advanced-lip-sync/{task_id}",
