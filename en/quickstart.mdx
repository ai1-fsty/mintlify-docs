...
Visit [ai.alad.com](https://ai.alad.com?lang=en) to register your account.

### Step 2: Get Your API Key

Go to the [Console](https://ai.alad.com/console/token?lang=en) to generate your API key. Keep it safe — you'll need it to authenticate every request.
...
<Warning>
  **Configure your channel first.** Different models correspond to different channels. You must enable the corresponding channel in the console before you can successfully call that model. Go to the [Console](https://ai.alad.com/console?lang=en) to confirm channels are enabled.
</Warning>
