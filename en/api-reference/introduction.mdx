---
title: "Introduction"
description: "Base URL, authentication, request format, and error handling for the Cube AI API."
---
...
```
https://ai.cubeuaeai.com
```

## Authentication

Cube AI uses Bearer Token authentication. Include your API key in the `Authorization` header of every request:

```
Authorization: Bearer YOUR_API_KEY
```

You can generate and manage API keys in the [Console](https://ai.cubeuaeai.com/console/token?lang=en).
...
Cube AI is compatible with the OpenAI SDK. Simply change the `base_url` to use it:
